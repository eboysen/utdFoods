...
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["app-home"]], decls: 49, vars: 3, consts: [[1, "contain"], [1, "gallary"], [1, "flex"], ["mat-stroked-button", "", 1, "but", 3, "click"], [1, "photos"], ["class", "pht", 4, "ngFor", "ngForOf"], ["class", "search", 4, "ngIf"], [1, "catagories"], [1, "card", 2, "background-image", "url('http://localhost:3000/images/breakfast')", "background-repeat", "no-repeat", "background-size", "cover", 3, "click"], [1, "label"], [1, "card", 2, "background-image", "url('http://localhost:3000/images/lunch')", "background-repeat", "no-repeat", "background-size", "cover", 3, "click"], [1, "card", 2, "background-image", "url('http://localhost:3000/images/dinner')", "background-repeat", "no-repeat", "background-size", "cover", 3, "click"], [1, "card", 2, "background-image", "url('http://localhost:3000/images/dessert')", "background-repeat", "no-repeat", "background-size", "cover", 3, "click"], [1, "card", 2, "background-image", "url('http://localhost:3000/images/snack')", "background-repeat", "no-repeat", "background-size", "cover", 3, "click"], [1, "card", 2, "background-image", "url('http://localhost:3000/images/chicken')", "background-repeat", "no-repeat", "background-size", "cover", 3, "click"], [1, "card", 2, "background-image", "url('http://localhost:3000/images/beef')", "background-repeat", "no-repeat", "background-size", "cover", 3, "click"], [1, "card", 2, "background-image", "url('http://localhost:3000/images/pork')", "background-repeat", "no-repeat", "background-size", "cover", 3, "click"], [1, "card", 2, "background-image", "url('http://localhost:3000/images/vegetarian')", "background-repeat", "no-repeat", "background-size", "cover", 3, "click"], [1, "body"], [1, "new"], [4, "ngFor", "ngForOf"], [1, "pht"], ["class", "img", "onerror", "this.src='http://localhost:3000/images/default'", 3, "src", "click", 4, "ngIf"], ["onerror", "this.src='http://localhost:3000/images/default'", 1, "img", 3, "src", "click"], [1, "search"], [1, "center"], [4, "ngIf"], ["type", "search", "placeholder", "Find Your Recipes...", 1, "bar", 3, "keyup.enter"], ["bigSearch", ""], [3, "click"], ["rowspan", "2"], ["onerror", "this.onerror=null; this.src='http://localhost:3000/images/default'", 1, "thumb", 3, "src"], [1, "desc"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 0);
